...
let virtualization_examples = [
  ...
  },
  {
    ...
    tekst: [
      ...
      {avsnitt: "Da er installasjonen til virtuell maskin ferdig og den er klar for bruk. Til slutt vil du bli spurt om hvilken øsnker du for skrivebordet i virtuell maskin. Deretter når du er ferdig med å bestemme hvilken størrelse, trykk på <b>´´Connect´´</b>"}
    ],
      bilde_til_avsnitt: [
      {
        bilde: [
