...
let virtualization_examples = [
  ...
  },
  {
    ...
    tekst: [
      ...
      {avsnitt: ""},
      {avsnitt: "Når du er på dette vinduet, vil de i utgangspunktet be deg om å gi tilgang til posisjonen din, hvis du ønsker å gjøre det, trykk på <b>den øverst</b> og hvis ikke du ønsker å gjøre det, trykk på <b>den som er under.</b> Hvis du har ønske om å få mer informasjon om dette, kan du trykke på knappen <b>Learn more.</b> Etter at du har valgt, trykk på knappen <b>Accept.</b>"},
      {avsnitt: "I dette vinduet, vil de si spørre deg om å gi tilgang for Find my device. Det vil hjelpe deg med å finne maskinen din, hvis du mister den et sted. Hvis du ønsker å gi tilgang til Find my device, trykk på <b>den øverst</b> (du vil trenge et Microsoft-konto) og hvis du ikke ønsker å gjøre det, trykk på <b>den som er under.</b> Hvis du vil ha mer informasjon om dette, kan du trykke på knappen <b>Learn more</b> og dersom du har valgt, trykk på knappen <b>Accept.</b>"},
      {avsnitt: "Nå vil de spørre deg i utgangspunktet om å gi tilgang til hvor masse informasjon vil du dele. Hvis du ønsker å dele full data, da kan du trykke på <b>den øverst</b> og hvis ikke du ønsker å gjøre det, trykk på <b>den som er under.</b> Du kan få mer informasjon om dette ved å trykke på knappen <b>Learn more.</b> Når du har valgt, trykk på knappen <b>Accept.</b>"},
      ...
      {avsnitt:"Her i dette steget, vil de ha tilgang til reklame-ID din, som vil føre til mer personlig annonsering (det vil si at du kommer til å få annonser som er relevante for deg), hvis du ønsker å gjøre det, trykk på den øverst og hvis du ikke ønsker å gjøre det, trykk på den som er under. Hvis du har lyst til å mer informasjon om dette, trykke på knappen Learn more. Dersom du har tatt valget ditt, trykk på knappen <b>Accept.</b>"},
      {avsnitt: ""},
      ...
      {avsnitt: "Da er installasjonen til virtuell maskin ferdig og den er klar for bruk. Til slutt vil du bli spurt om hvilken størrelse øsnker du for skrivebordet i virtuell maskin din. Deretter når du er ferdig med å bestemme hvilken størrelse, trykk på knappen <br><b>´´Connect´´</b>."}
    ],
      bilde_til_avsnitt: [
      {
        bilde: [
        ...
        },
      {
       ...
       },
       {
         bilde: [
           ...
           "<br>For å lage et sterkt og godt passord som er nesten umulig å vite, kan du bruke forskjellige tegn som f.eks. som @ # $ %. Husk at når du lager et veldig sterkt passord, bør du lagre passordet ditt et sted, for at du ikke glemmer det. (For eksempel anbefalt å sjekke ut Lastpass, under ligger det leken for Lastpass)." +
  ...
  },
  {
    ...
    tekst: [
      ...
      {avsnitt: "<br><p style='line-height:170%'><b>Ekstern:</b><br> Den lager et virtuelt switch som kobler seg til den fysiske adapteren, slik at de virtuelle maskinene får tilgang til det fysiske nettverket. Samtidig vil de få IP-adressen av nettverket som vår hovedmaskin har. Deretter vil de få kobling til internett.</p><br>" +
                "<p><img src='VS/ekstern.png' width='300px' height='200px'></p>" +
                "<br><p style='line-height:170%'><b>Intern:</b><br>Den er veldig lik som privat svitsj, men bare at med intern vil det bli opprettet en virtuell adapter i din hoved (host) maskin, og deretter den virtuelle adapteren som ble opprettet, vil være en del av det virtuelle nettverket. Da vil det være mulig for din hovedmaskin å kommunisere med de virtuelle maskinene også.</p><br>" +
                "<p><img src='VS/intern.png' width='300px' height='200px'></p>" +
                "<br><p style='line-height:170%'><b>Privat: </b><br>Den gir et isolert miljø, hvor de virtuelle maskiner er kun avhengig av hverandre og deretter kan man lage sammenkoblet internet mellom dem. Da kan de virtuelle maskinene kommunisere med hverandre og dermed vil ikke din hovedmaskin få kobling til virtuelle maskins nettverksområde.</p><br>" +
